...
trait CompilesComponents
{
    ...
    public static function compileClassComponentOpening(string $component, string $alias, string $data, string $hash)
    {
        return implode("\n", [
            ...
            '<?php $__extractedSlotData = array_keys($component->slotData()); ?>',
            '<?php extract($component->slotData()); ?>',
    ...
    public function compileEndComponentClass()
    {
        ...
        return $this->compileEndComponent()."\n".implode("\n", [
            ...
            '<?php endif; ?>',
            '<?php if (isset($__extractedSlotData)): ?>',
            '<?php foreach($__extractedSlotData as $__slotKey) { unset($$__slotKey); } ?>',
            '<?php unset($__extractedSlotData); ?>',
            '<?php endif; ?>',
